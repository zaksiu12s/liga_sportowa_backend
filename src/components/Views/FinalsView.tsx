const FinalsView = () => {
  return (
    <div className="max-w-4xl mx-auto py-12 space-y-24 dark:text-white">
      <div className="text-center border-b-4 border-gray-900 pb-2 inline-block mx-auto w-full dark:border-white">
